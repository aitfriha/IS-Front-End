...
class RoleAbility extends React.Component {
    constructor(props) {
        ...
        this.state = {
            columns: [
                {
                    title: intl.formatMessage({ id: 'role.name' }) + '*',
                    field: 'roleName'
                }, {
                    title: intl.formatMessage({ id: 'role.description' }),
    ...
    render() {
        const {
            classes, location, intl, allRoles, addRole, errors, isLoading, roleResponse, getAllRoles, updateRole, deleteRole, allActions, allSubjects, addRoleAbilities
        } = this.props;
